...
int main()
{
  ...
  double Kp = 2.5;         //This is the proportional control
	double Kd = 1.6;
  double time = 0;
	double P0 = 0;
  ...
  try{
    ...
    robot.control([&](const franka::RobotState& robot_state, franka::Duration period) -> franka::JointVelocities {
      ...
      if (time<=T[2]){
        ...
        desired_position[0] = initial_pose[12] + P1;
      ...
      if (time > T[2] && time <= T[3]){
        ...
        desired_position[0] = initial_pose[12] + P2;
        desired_position[1] = initial_pose[13];
        desired_position[2] = initial_pose[14];
        ...
        desired_velocity[2] = 0;
			...
			if (time > T[3] && time <= T[4]){
				...
				desired_position[0] = initial_pose[12] + P3;
				desired_position[1] = initial_pose[13];
				desired_position[2] = initial_pose[14];
        ...
        desired_velocity[2] = 0;
			...
			if (time > T[4] && time <= T[5]){
			  ...
			  desired_position[0] = initial_pose[12] + P4;
			  desired_position[1] = initial_pose[13];
			  desired_position[2] = initial_pose[14];
        ...
        desired_velocity[2] = 0;
			...
			if (time > T[5] && time <= T[6]){
			  ...
			  desired_position[0] = initial_pose[12] + P5;
			  desired_position[1] = initial_pose[13];
			  desired_position[2] = initial_pose[14];
        ...
        desired_velocity[2] = 0;
			...
			if (time > T[6] && time <= T[7]){
			  ...
			  desired_position[0] = initial_pose[12] + P6;
			  desired_position[1] = initial_pose[13];
			  desired_position[2] = initial_pose[14];
        ...
        desired_velocity[2] = 0;
			...
			if (time > T[7] && time <= T[8]){
			  ...
			  desired_position[0] = initial_pose[12] + P7;
			  desired_position[1] = initial_pose[13];
			  desired_position[2] = initial_pose[14];
      ...
      //franka::RobotState robot_state = robot.readOnce();
        ...
        current_velocity << current_twist[0],0,0;
        ...
        x_dot[1] = Kp*error[1] + 0;
        x_dot[2] = Kp*error[2] + 0;
        ...
        if (error_norm <= 0.001 && time >= (total_time+5)) {
